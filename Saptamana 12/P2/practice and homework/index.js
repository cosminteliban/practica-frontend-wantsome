...
const newPerson = new Person("Jack", "O'Neill")
...
class Lion extends Animal {
  ...
  showBehaviour() {
    return `${super.eatFood()} and ${this.rage()}`;
  }
...
let leo = new Lion("Snow", "30")
console.log(leo.walking())
console.log(leo.rage())
console.log(leo.showBehaviour())
console.log(leo.dailyRoutine())
...
//2.1 - clasa Transaction sa aiba un get-ter finalSum() care sa scada din amount 10;
...
class Account {
  ...
  newBankAccount() {
    return `${this.name} opened a new bank account at ${this.location}.`
  }
}
const bankAccount = new Account("Marcel", "Saraki Bank");
console.log(bankAccount.newBankAccount())
...
const firstTransaction = new Transaction("Covidut", "Saraki Bank", "999", "partikipare concurs Andra");
const secondTransaction = new Transaction("Covidina", "Saraki Bank", "999", "partikipare concurs Andra");
console.log(firstTransaction)
console.log(secondTransaction)
console.log(firstTransaction.finalSum)
...
table.addTransaction(firstTransaction, secondTransaction)
console.log(table)
